...
<#macro routepoint idx rp={} restrictedit=true add=true remove=true >
    <tr class="route-point" data-rp-idx="${idx}">
        ...
        <td class="col-xs-2">
            ...
            <select name="countryList" id="country" form="data" required>
        ...
        <td class="col-xs-2"><input name="routePoints[${idx}].arrival" type="text" class="time" data-format="HH:mm" data-template="HH : mm"></td>
        <td class="col-xs-2"><input name="routePoints[${idx}].departure" type="text" class="time" data-format="HH:mm" data-template="HH : mm"></td>
